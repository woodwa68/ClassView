...
function GDocs(selector) {
  ...
  this.__defineGetter__('UPLOAD_CONTENT', function() {
 ...
 */
GDocs.prototype.upload = function(blob, parents, callback, retry) {

  var onComplete = function(response) {
      document.getElementById('dropper').classList.remove('uploading');
  ...
  document.getElementById('dropper').classList.add('uploading');
  uploader.upload();
